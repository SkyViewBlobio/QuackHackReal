...
//        this.setToggled(false); // Explicitly disable on creation
//
//        //Creating left click settings
//        Setting leftActive = new Setting("Left Click", this, false);
...
//        Setting rightActive = new Setting("Right Click", this, false);
...
//
//        Setting breakBlocks = new Setting("Break blocks", this, false);
...
//        }
//        this.updateVals();
//        if (!rightActive && !leftActive && this.isToggled()) {
//            System.out.println("AutoClicker toggled: " + this.isToggled());
...
//        System.out.println("onDisabled executed for AutoClicker");
//        this.ravenBreakWtf = false;
//        super.onDisabled();
//    }
//
